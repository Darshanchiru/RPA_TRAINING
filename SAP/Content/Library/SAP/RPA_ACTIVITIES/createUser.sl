...
operation:
  ...
  inputs:
    ...
    - password
  sequential_action:
    gav: 'com.microfocus.seq:SAP.RPA_ACTIVITIES.createUser:1.0.0'
    skills:
      - SAP
      - Web
    settings:
    ...
    steps:
      ...
      - step:
          id: '3'
          object_path: 'SAPGuiSession("Session").SAPGuiWindow("SAP Easy Access").SAPGuiButton("Enter")'
          action: Click
          snapshot: ".\\Snapshots\\ssf1.png"
          highlight_id: '4'
      - step:
      ...
      - step:
          ...
          action: Set
          default_args: '"darshan.a@gmail.com"'
          snapshot: ".\\Snapshots\\ssf3.png"
          highlight_id: '44'
          ...
          - object:
              ...
              child_objects:
                - object:
                    ...
                    visual_relations: ''
                    last_update_time: 'Thursday, June 18, 2020 9:38:32 AM'
